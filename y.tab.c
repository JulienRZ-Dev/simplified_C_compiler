...
{
       0,   105,   105,   115,   121,   124,   132,   138,   139,   145,
     146,   151,   153,   155,   157,   159,   164,   166,   170,   177,
     194,   217,   237,   247,   259,   264,   283,   296,   310,   315,
     332,   349,   366,   383,   387,   403,   411,   418,   423,   440,
     457,   476,   501,   509
};
#endif
...
{
  "$end", "error", "$undefined", "tMain", "tPrintf", "tIf", "tElse",
  "tWhile", "tParentheseOuvrante", "tParentheseFermante",
  "tCrochetOuvrant", "tCrochetFermant", "tConst", "tInt", "tAdd", "tSub",
  "tMul", "tDiv", "tEq", "tInf", "tSup", "tEqEq", "tComma",
  "tEndOfInstruction", "tVar", "tNombre", "tExp", "$accept", "File",
  "Main", "Body", "InitBody", "VarDeclarations", "Instructions",
  "Instruction", "Type", "Value", "Affectation", "Variables",
  "VarDeclaration", "Printf", "Entite", "Operande", "If",
  "IfCrochetOuvrant", "IfCrochetFermant", "Cond", "While",
  "WhileCrochetOuvrant", "WhileCrochetFermant", YY_NULLPTR
};
#endif
...
{
       4,   -36,    19,    22,   -36,    33,    40,    44,    45,    34,
     -36,   -36,   -36,    -2,    35,    34,    49,    50,    52,    -4,
      43,   -36,   -36,    -2,   -36,   -36,   -36,   -36,    -3,   -36,
     -36,    26,   -36,   -36,    38,    27,    27,   -36,     1,     0,
     -36,    -4,    -4,    -4,    -4,    35,   -36,    54,    20,    55,
      56,   -36,    46,    47,    21,    37,    37,   -36,   -36,   -36,
      48,    27,    27,    27,    57,    58,   -36,   -36,   -36,   -36,
     -36,   -36,   -36,   -36,    44,   -36,    44,    61,    62,   -36,
     -36,   -36,   -36
};
...
{
       0,     3,     0,     0,     1,     0,     0,     6,     0,     8,
       2,    17,    16,    10,     0,     8,     0,     0,     0,     0,
      27,    18,     5,    10,    26,    13,    11,    33,    12,    14,
      15,     0,    24,     7,     0,     0,     0,    27,     0,     0,
       9,     0,     0,     0,     0,     0,    22,     0,    37,     0,
       0,    28,    27,    26,     0,    29,    30,    31,    32,    23,
       0,     0,     0,     0,     0,     0,    20,    19,    21,    25,
      38,    39,    40,    35,     6,    42,     6,     0,     0,    36,
      34,    43,    41
};
...
{
     -36,   -36,   -36,   -31,   -36,    51,    53,   -36,   -36,    36,
     -36,    29,   -36,   -36,   -35,   -10,   -36,   -36,   -36,    41,
     -36,   -36,   -36
};
...
{
      -1,     2,     3,     8,     9,    13,    22,    23,    14,    24,
      25,    32,    15,    26,    27,    28,    29,    74,    80,    49,
      30,    76,    82
};
...
{
      48,    48,    16,    17,    19,    18,    19,     1,    19,    38,
      51,    41,    42,    43,    44,    41,    42,    43,    44,     4,
      37,    21,    20,    21,    52,    21,    70,    71,    72,    54,
       5,    55,    56,    57,    58,    41,    42,    43,    44,    61,
      62,    63,     6,    77,    68,    78,    11,    12,    45,    46,
       7,    37,    21,    43,    44,    -4,    10,    34,    35,    31,
      36,    39,    47,    60,    64,    65,    33,    73,    75,    66,
      67,    69,    79,    81,    59,    53,    40,    50
};

static const yytype_uint8 yycheck[] =
{
      35,    36,     4,     5,     8,     7,     8,     3,     8,    19,
       9,    14,    15,    16,    17,    14,    15,    16,    17,     0,
      24,    25,    24,    25,    24,    25,    61,    62,    63,    39,
       8,    41,    42,    43,    44,    14,    15,    16,    17,    19,
      20,    21,     9,    74,    23,    76,    12,    13,    22,    23,
      10,    24,    25,    16,    17,    11,    11,     8,     8,    24,
       8,    18,    24,     9,     9,     9,    15,    10,    10,    23,
      23,    23,    11,    11,    45,    39,    23,    36
};
...
{
       0,     3,    28,    29,     0,     8,     9,    10,    30,    31,
      11,    12,    13,    32,    35,    39,     4,     5,     7,     8,
      24,    25,    33,    34,    36,    37,    40,    41,    42,    43,
      47,    24,    38,    32,     8,     8,     8,    24,    42,    18,
      33,    14,    15,    16,    17,    22,    23,    24,    41,    46,
      46,     9,    24,    36,    42,    42,    42,    42,    42,    38,
       9,    19,    20,    21,     9,     9,    23,    23,    23,    23,
      41,    41,    41,    10,    44,    10,    48,    30,    30,    11,
      45,    11,    49
};
...
{
       0,    27,    28,    29,    30,    30,    31,    32,    32,    33,
      33,    34,    34,    34,    34,    34,    35,    35,    36,    37,
...
#line 178 "compiler.y" /* yacc.c:1646  */
    {
            int adr = get_index((yyvsp[-3].var), depth); 
            if(adr == -1)
            {
            ...
            instruction.op1 = adr;
            instruction.op2 = (yyvsp[-1].nombre);
...
#line 195 "compiler.y" /* yacc.c:1646  */
    {
            int adrTarget = get_index((yyvsp[-3].var), depth); 
            int adrSource = get_index((yyvsp[-1].var), depth);
            if(adrTarget == -1)
            {
                  printf("NULL POINTER EXCEPTION, %s not found at depth %d \n", (yyvsp[-3].var), depth);
                  exit(1);
...
#line 238 "compiler.y" /* yacc.c:1646  */
    {
            int adr = put_symbole((yyvsp[-1].var), depth); 
            if(adr == -1)
            {
...
#line 248 "compiler.y" /* yacc.c:1646  */
    {
            int adr = put_symbole((yyvsp[-2].var), depth); 
            if(adr == -1)
            {
                  printf("variable %s is already declared \n", (yyvsp[-2].var));
                  exit(1);
...
#line 265 "compiler.y" /* yacc.c:1646  */
    {
            int adr = get_index((yyvsp[-2].var), depth); 
            if(adr == -1)
            {
                  printf("NULL POINTER EXCEPTION, %s not found at depth %d \n", (yyvsp[-2].var), depth);
                  exit(1);
...
#line 284 "compiler.y" /* yacc.c:1646  */
    {
            ...
            instruction.codeOp = 6;
            instruction.op1 = adr;
            instruction.op2 = (yyvsp[0].nombre);
            instruction_table[instructionPointer] = instruction;
            instructionPointer++;
            (yyval.nombre) = adr;
      }
...
#line 297 "compiler.y" /* yacc.c:1646  */
    {
            int adr = get_index((yyvsp[0].var), depth);
            if(adr == -1)
            {
                  printf("NULL POINTER EXCEPTION, %s not found at depth %d \n", (yyvsp[0].var), depth);
                  exit(1);
...
#line 316 "compiler.y" /* yacc.c:1646  */
    {
            ...
            instruction.op1 = adr;
            instruction.op2 = (yyvsp[-2].nombre);
            instruction.op3 = (yyvsp[0].nombre);
            instruction_table[instructionPointer] = instruction;
            instructionPointer++;
            (yyval.nombre) = adr;
            pop();
...
#line 388 "compiler.y" /* yacc.c:1646  */
    {
            int adrCond = (yyvsp[-4].nombre);
            int indexJump = (yyvsp[-2].nombre);
            int adrJump = (yyvsp[0].nombre);
...
#line 404 "compiler.y" /* yacc.c:1646  */
    {
            (yyval.nombre) = instructionPointer;
            instructionPointer++;
      }
...
#line 510 "compiler.y" /* yacc.c:1646  */
    {
            (yyval.nombre) = instructionPointer + 1;
      }
...
#line 515 "compiler.y" /* yacc.c:1906  */
